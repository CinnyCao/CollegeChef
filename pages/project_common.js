...
function addRecipe() {
    $('#add-edit-recipe').attr('action', 'javascript:updateOrAddRecipe();');
...
function editRecipe(recipeId) {
    $('#add-edit-recipe').attr('action', 'javascript:updateOrAddRecipe(' + recipeId + ');');
...
function updateOrAddRecipe(recipeId = '-1'){
